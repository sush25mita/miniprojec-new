#include<stdio.h>
#include<string.h>
void intermediate(FILE*,char[],char[],char[],char[]);
...
int main()
{
    ...
    struct symtab s[20];
    FILE *fp,*fp1,*fp2;
    int i,j,l,symentry=0,c=0,len=0,k;
    char locctr[6]="0000";
    ...
    do
    {
        ...
        while(fscanf(fp1,"%s%s%s%s\n",ee.loctr,ee.labl,ee.mnem,ee.fiel)!=EOF)
        {
            ...
            else
            {
                ...
                {
                    if((j>75)||(strcmp(ee.mnem,"RESW")==0&&j>12)||(strcmp(ee.mnem,"RESB")==0&&j>12))
                    {
                        c=0;
                    ...
                    if((strcmp(ee.mnem,"RESW")==0)||(strcmp(ee.mnem,"RESB")==0))
                        j=0;
                    fp2=fopen("optab.txt","r");
                    c=0;
                    while((fscanf(fp2,"%s%s\n",e1.mne,e1.opcd))!=EOF)
                    ...
                    else if(strcmp(ee.mnem,"BYTE")==0)
                    {
                        if(ee.fiel[0]=='X')
                        {
                            for(i=2;ee.fiel[i]!='\0';i++)
                            {
                                if((ee.fiel[i]>='0'&&ee.fiel[i]<='9')||(ee.fiel[i]>='A'&&ee.fiel[i]<='F'))
                                {
                                    record[j]=ee.fiel[i];
                                    len++;
                                    j++;
